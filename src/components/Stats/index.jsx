...
const Stats = () => {
  return (
    <div className="w-[85%] mx-auto py-[4em] sm:pb-[8em] pb-[4em]">
      ...
      <p className="text-white sm:text-heading text-[24px] sm:w-[30%] w-[100%] font-secondary font-medium">
        My kitchening catalogue.
      </p>

      <div className="flex sm:flex-row flex-col justify-around items-center text-center text-white mt-8">
